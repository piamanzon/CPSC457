...
//Responsible for removing student from the queue and sitting them
void *consumer(void *arg){
    ...
    while(true){
        ...
        wait = round(milli(endWaitTime - (*chosenCustomer).beginTime).count());
        turnAround = wait + (*chosenCustomer).eatingTimeLeft;
